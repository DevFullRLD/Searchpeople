...
<html>
    <head>
        <title>Pessoa Fisica | Search People </title>
    ...
    <body style="padding: 0px 0px 0px 0px ; background-color:#f2f2f2;">
        ...
        <h1 class="h3 mb-3 font-weight-normal" style="text-align: center"><font face="Azonix" size="6" color="Black">Search People</font></h1><br><br>
            <?php
                // Formulario Pessoa Fisica
                require_once "include/formularios/FrmPessoaFisica.php";
            ?>
        </div>
        <!-- Fim do Conteudo -->
        <!-- Script da pagina -->
