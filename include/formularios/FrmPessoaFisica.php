...
<form id="FrmPessoaFisica" name="cadastro" onsubmit="return validaPessoaFisica()" action="MySQL/insertPessoaFisica.php" method="POST" autocomplete="off">
    <div class="form-row">
