<div class="card">
    ...
    <div class="card-body">
        <div class="col-sm-3">
            <img style="margin-top:40px;margin-left:20px" src="img/MyAccount/perfil.png" alt="" class="img-rounded img-responsive" />
        </div>
        <div class="col-sm-9">
            <table style="margin-left:30px" class="table table-borderless">
                ...
                <tr>
                    <td>Data de Nascimento: <?php echo $Nascimento ?></td>
                </tr>
                <tr>
                    <td >CPF: <?php echo $CPF_CNPJ ?></td><br>
                </tr>
                <tr>
                    <td>RG: <?php echo $RG ?></td>
                </tr>
                <tr>
